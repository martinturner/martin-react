...
const InteractiveLight = () => {
  //meta title
  document.title = "Themebau | Interactive Light";
  ...
  return (
    <React.Fragment>
          ...
          <Row className="justify-content-center">
            <Col lg={10} className="col-12">
              ...
              <div className="mt-30 pb-100 ps-lg-3 position-relative">
                <h3 className="mb-60">
                  Do you have NavLink project?
                  <br />
                  Send us NavLink message and let's connect 👋
                </h3>
                <NavLink to="/contact1" className="btn btn-dark btn-with-ball">
                  let’s work
      ...
      <footer className="footer overflow-hidden pb-60" id="footer">
        <Container className="pb-10">
          ...
          <Row className="gh-1 gv-2">
            ...
            <Col className="col-auto mt-md-04">
              <ul className="nav nav-gap-sm align-items-center justify-content-center mb-30">
                <li className="nav-item">
                  <NavLink
