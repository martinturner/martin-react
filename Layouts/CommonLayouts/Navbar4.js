...
const Navbar = ({ navClass, styleClass }) => {
  ...
  const toggleMenu = () => {
    ...
    document.getElementById("navbar-mobile-style-" + styleClass).style.display = "block";
    if (styleClass === "3") {
      document.documentElement.scrollTop = 0;
    }
    if (styleClass === "2") {
  ...
  const toggleRemove = useCallback(() => {
    ...
    document.getElementById("navbar-mobile-style-" + styleClass).style.display = "none";
    if (styleClass === "2") {
  ...
  const scrollNavigation = () => {
    ...
    if (scrollup > 100) {
      element.classList.add("cursor-enabled", "navbar-show", "navbar-scroll");
      element.classList.remove("navbar-hide");
      ...
      </header>
      {
        styleClass === "2" ?
          ...
          >
            ...
            <Container>
              <Row className="gh-1 justify-content-center" id="navBar">
          ...
          :
          <div className="navbar navbar-mobile navbar-mobile-style-3 fancybox-content" style={{ height: "100vh", overflowY: "auto" }} id="navbar-mobile-style-3">
            <div className="navbar-wrapper">
              <div className="navbar-head">
                <Link className="navbar-brand d-block d-md-none" to="/home">
                  {(navClass && navClass.includes("navbar-dark")) ? <img width="107" src={Logolight} alt="logo" /> : <img width="107" src={Logo} alt="logo" />}
                </Link>
                <Link className="navbar-toggle ms-md-auto" to="#" onClick={() => toggleRemove()} >
                  <span></span>
                  <span></span>
                  <span></span>
                </Link>
              ...
              <div className="navbar-footer">
                <ul className="list-group borderless mb-30">
                  <li className="list-group-item">Email: <Link to="mailto:hello@themebau.com?subject=Test%20Address%20Email" className="text-decoration-none">hello@themebau.com</Link></li>
                  <li className="list-group-item"> Phone: <Link to="callto:+1 202-358-0309" className="text-decoration-none">+1 202-358-0309</Link>
                  </li>
                </ul>
                <ul className="nav nav-gap-sm navbar-nav nav-social align-items-center pt-3">
                  <li className="nav-item">
                  ...
                  <li className="nav-item">
                    <Link to="https://twitter.com/runwebrun" className="nav-link">
                  ...
                  <li className="nav-item">
                    <Link to="https://instagram.com/runwebrun" className="nav-link">
