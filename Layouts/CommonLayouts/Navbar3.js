...
const Navbar = ({ navClass }) => {
  ...
  return (
    <React.Fragment>
      ...
      <div
        className="navbar navbar-mobile navbar-mobile-style-2 bg-white"
                    ...
                    <UncontrolledCollapse toggler="#navbarCollapseProjects" className="navbar-collapse-menu">
                      <ul className="nav navbar-nav">
                        <li className="nav-item navbar-collapse">
                          ...
                          <UncontrolledCollapse toggler="#navbarCollapse1Column" className={`navbar-collapse-menu ${collapse === true ? 'show' : ''}`}>
                            <ul className="nav navbar-nav">
                              <li className="nav-item">
                                <Link
                        ...
                        <li className="nav-item navbar-collapse">
                          ...
                          <UncontrolledCollapse toggler="#navbarCollapse2Column" className={`navbar-collapse-menu ${collapse1 === true ? 'show' : ''}`}>
                            <ul className="nav navbar-nav">
                              <li className="nav-item">
                                <Link
