...
import videomp4 from "../assets/videos/coming-soon.mp4";
//Import Countdown
...
const ComingSoon = () => {
  //meta title
  document.title = " Themebau | Coming Soon";
  const renderer = ({ days, hours, minutes, seconds, completed }) => {
    if (completed) {
      // Render NavLink completed state
      return <span>00 00 00 00</span>;
    } else {
      return (
        <>
          <div className="countdown-item" data-aos="fade-up">
            <span>{days} </span>
            <span>Days</span>
          </div>
          <div className="countdown-separator" data-aos="fade-up">
            :
          </div>
          <div className="countdown-item" data-aos="fade-up">
            <span> {hours}</span>
        ...
        <div className="min-vh-100 text-center pt-130 pb-40 d-flex align-items-center">
          <div className="background">
            ...
            <div
              ...
              style={{ backgroundColor: "#0e0e0e", opacity: ".4" }}
            ></div>
          </div>
          <Container className="h-100 text-white d-flex align-items-center justify-content-center">
            <div className="d-flex flex-column align-items-center justify-content-between w-100">
              <div>
                <h1 className="text-white mt-n4 mb-15" data-aos="fade-up">
                  Themebau.
                </h1>
                <p className="mb-12" data-aos="fade-up">
                  We’ll be here soon with our website, subscribe to be notified.
                </p>
              </div>
              <div className="mt-60 mb-60">
                <div className="countdown h2 text-white d-flex justify-content-center">
                  <Countdown date="2023/12/31" renderer={renderer} />
                </div>
              </div>
              <Row className="justify-content-center w-100 mt-20">
                <Form className="col-lg-7" action="#" data-aos="fade-up">
                  <div className="form-group-overlay">
                    ...
                    />
                    <button className="btn btn-clean btn-with-ball text-white">
                      send
