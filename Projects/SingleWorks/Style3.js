...
import img1 from "../../../assets/images/single-portfolio/style-3-1-1170-1160.jpg";
import img2 from "../../../assets/images/single-portfolio/style-3-2-1170-1160.jpg";
import img3 from "../../../assets/images/single-portfolio/style-3-3-1170-1160.jpg";
import { Col, Container, Row } from "reactstrap";

const Style3 = () => {
  //meta title
  document.title = "Themebau | Single Work 3";
        ...
        <Container>
          <Row className="gv-3">
            <Col lg={6} className="col-12">
              <Row className="gv-1">
                <Col className="col-12" data-aos="fade-right">
                  <div
            ...
            <Col
              ...
              data-aos="fade-left"
            >
              <div className="py-lg-2 py-xl-130 sticky-top">
                <h1 className="h2 mt-60 mt-lg-0">Video Tutorial</h1>
          ...
          <div className="page-navigation mt-160">
            <NavLink to="/portfolio-single-style-2" className="btn btn-clean">
              <svg
